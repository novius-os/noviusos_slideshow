...
return array(
    ...
    'Slideshow ‘{{title}}’' => 'Photo-serie ‘{{title}}’',

    #: views/admin/enhancer/preview.view.php:17
    '(format: {{format}})' => '(formate: {{format}})',
...
<li>Pos, (it ne va esser long), reveni a ti tabul pro inserter tu nov magnific photo-serie.</li></ul>',
    ...
    'To publish this slideshow, add it to a page, a blog post or any other text editor.' => 'Por publicar ti photo-serie, addi it a un pagine, un blog post o un altri textu editor.',

    #: views/admin/warning_not_published.view.php:22
    '<p>Most Novius OS text editors (also called WYSIWYG editors) feature this button {{preview}} in the toolbar.</p><p>Click it to access the list of applications you can enhance your text with.</p>' => 'Quasi omni textu editors de Novius OS (anc nominat WYSIWYG editors) have ti buton {{preview}} in li utilbar.</p><p>Clica it por accesser li liste de applications que posse ameliorar tu textu.</p>',

    #: views/admin/warning_not_published.view.php:23
    'Applications' => 'Applications',

    #: views/admin/renderer/page_selector.view.php:6
    'Add a link' => 'Addir un ligator',

    #: views/admin/renderer/page_selector.view.php:10
    'Remove the link' => 'Remover li ligator',

    #: config/slideshow.config.php:17
    'Big Flexslider v1.8' => 'Grand Flexslider v1.8',
    ...
    #. Crud
    #: config/common/slideshow.config.php:56
    'Added! This is a nice new slideshow you have here.' => 'Addit! Vi un magnific photo-serie.',

    #: config/common/slideshow.config.php:57
    'The slideshow has been deleted.' => 'Ti photo-serie ha esset deletet.',

    #. General errors
    #: config/common/slideshow.config.php:60
    'This slideshow doesn’t exist any more. It has been deleted.' => 'Ti photo-serie ne plu existe. It ha esset deletet.',

    #: config/common/slideshow.config.php:61
    'We cannot find this slideshow.' => 'Ne posse truvar ti photo-serie',
