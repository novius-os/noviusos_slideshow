...
return array(
    ...
    'messages' => array(
        ...
        'exists in multiple site' => __('This slideshow exists in <strong>{count} sites</strong>.'),
        'delete in the following sites' => __('Delete this slideshow in the following sites:'),
